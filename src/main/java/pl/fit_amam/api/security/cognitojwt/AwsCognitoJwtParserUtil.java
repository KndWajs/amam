...
public class AwsCognitoJwtParserUtil {
     ...
     */
    public static JsonObject getHeader(String jwt) throws TokenException {
        try {
            validateJWT(jwt);
            ...
            throw new TokenException(HttpStatus.UNAUTHORIZED, AuthenticationError.NOT_VALID_JSON_WEB_TOKEN);
        }
     ...
     */
    public static JsonObject getPayload(String jwt) throws TokenException {
        try {
            validateJWT(jwt);
     ...
     */
    public static String getSignature(String jwt) throws TokenException {
        try {
            validateJWT(jwt);
     ...
     */
    public static String getClaim(String jwt, String claim) throws TokenException {
        try {
    ...
    public static void validateJWT(String jwt) throws TokenException {
        ...
        if (jwt == null) {
            throw new TokenException(HttpStatus.UNAUTHORIZED, AuthenticationError.TOKEN_MISSING);
        }
     ...
     */
    public static String getJsonWebKeyURL(String token) throws TokenException {
     ...
     */
    public static File getJsonWebKeyFile(String token) throws TokenException, IOException {
        ...
        if (APIRestUtil.isHTTPError(responseEntity.getStatusCode())) {
            throw new TokenException(responseEntity.getStatusCode(), AuthenticationError.NOT_VALID_JSON_WEB_TOKEN);
